...
export const bn: TypeLanguage = {
	...
	analytic: {
		...
		warning:
			'একটি অগ্রগতি গ্রাফ প্রদর্শন করা সম্ভব নয় কারণ এই মুহূর্তে সক্রিয় ওষুধের সংখ্যা 20 টির বেশি',
		...
		bar: {
			title: 'গত 5 বছরে নেওয়া ওষুধের সংখ্যা',
		},
		...
		contribution: {
			title: 'গত 2 মাস ধরে ওষুধ ব্যবহারের কার্যকলাপ',
		},
	},
