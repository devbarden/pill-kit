...
export const bn: TypeLanguage = {
	...
	welcome: {
		...
		modal: {
			...
			notification: {
				title: 'বিজ্ঞপ্তি',
				description:
					'অনুস্মারক পেতে অ্যাপটিকে বিজ্ঞপ্তি পাঠানোর অনুমতি দিন। অন্যথায়, আমরা আপনাকে ওষুধ নেওয়ার সময় মনে করিয়ে দিতে পারব না',
			},
		},
	},
	...
	home: {
		add: 'যোগ করুন',
		empty:
			'কোনো সক্রিয় বা আসন্ন ঔষধ সনাক্ত করা হয়নি। দয়া করে আপনার চিকিত্সা নিরীক্ষণ করতে একটি ঔষধ যোগ করুন',
	},
	...
	settings: {
		...
		modal: {
			clearAllData: {
				...
				description:
					'আপনি কি সত্যিই সমস্ত ডেটা মুছে ফেলতে চান? এই ক্রিয়াটি অপরিবর্তনীয়',
			},
		},
	},
	...
	medicine: {
		...
		modal: {
			...
			remove: {
				title: 'ওষুধ সরান',
				description:
					'আপনি কি সত্যিই এই ঔষধটি মুছে ফেলতে চান? এই ক্রিয়াটি অপরিবর্তনীয়',
			},
		},

		warning: {
			past: 'অতীতের সময় পরিসীমা। আপনি হোম স্ক্রিনে এই ঔষধটি দেখতে পাবেন না',
	...
	notification: {
		medicine: {
			...
			error: 'কিছু ভুল হয়েছে। আমরা সমস্যাটি নিয়ে কাজ করছি',
		},
	},

	error: {
		title: 'কিছু ভেঙে গেছে। দয়া করে ইমেইলের মাধ্যমে আমাদের সাথে যোগাযোগ করুন',
		reset: 'রিসেট ত্রুটি',
	},
}
