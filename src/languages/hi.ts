...
export const hi: TypeLanguage = {
	reminders: {
		takeMedicine: `दवा लेने का समय आ गया है।`,
	},

	welcome: {
		title:
			'स्वागत है! कृपया एप्लिकेशन का उपयोग करने से पहले निम्नलिखित दस्तावेज़ पढ़ें',
		...
		modal: {
			...
			notification: {
				title: 'सूचनाएं',
				description:
					'अनुस्मारक प्राप्त करने के लिए, कृपया ऐप को सूचनाएं भेजने की अनुमति दें। अन्यथा, हम आपको आपकी दवाइयां लेने के लिए याद नहीं दिला पाएंगे',
			},
		},
	},
	...
	home: {
		add: 'जोड़ना',
		empty:
			'कोई सक्रिय या आगामी दवाइयां नहीं पाई गई हैं। कृपया अपने उपचार की निगरानी के लिए एक दवा जोड़ें',
	},
	...
	settings: {
		...
		modal: {
			clearAllData: {
				...
				description:
					'क्या आप वास्तव में सभी डेटा हटाना चाहते हैं? यह क्रिया अपरिवर्तनीय है',
			},
		},
	},
	...
	medicine: {
		...
		modal: {
			...
			remove: {
				title: 'दवा हटाओ',
				description:
					'क्या आप वास्तव में इस दवाई को हटाना चाहते हैं? यह क्रिया अपरिवर्तनीय है',
			},
		},

		warning: {
			past: 'समय सीमा अतीत में है। आप इस दवाई को होम स्क्रीन पर नहीं देखेंगे',
	...
	notification: {
		medicine: {
			...
			error: 'कुछ गलत हो गया है। हम समस्या पर काम कर रहे हैं',
		},
	},

	error: {
		title: 'कुछ टूट गया है। कृपया हमें ईमेल के माध्यम से संपर्क करें',
