...
export const be: TypeLanguage = {
	reminders: {
		takeMedicine: `Прышла пара прымаць лякарства`,
	},
	...
	welcome: {
		...
		modal: {
			...
			notification: {
				title: 'Апавяшчэнні',
				description:
					'Каб атрымліваць напаміны, дазвольце праграме адпраўляць апавяшчэнні, у адваротным выпадку мы не зможам нагадваць вам, калі прымаць лекі.',
			},
		},
	},
	...
	home: {
		add: 'Дабавіць',
		empty:
			'Не выяўлена актыўных ці будучых лекаў. Калі ласка, дадайце лек для кантролю за вашым лячэннем',
	},
