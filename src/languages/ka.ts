...
export const ka: TypeLanguage = {
	welcome: {
		...
		modal: {
			...
			notification: {
				title: 'შეტყობინებები',
				description:
					'შეხსენებების მისაღებად, გთხოვთ, ნება მიეცით აპს გააგზავნოს შეტყობინებები, წინააღმდეგ შემთხვევაში, ჩვენ ვერ შეგახსენებთ, როდის უნდა მიიღოთ თქვენი მედიკამენტები.',
			},
		},
	},
	...
	home: {
		add: 'დამატება',
		empty: 'აქტიური ან მომავალი მედიკამენტები არ არის გამოვლენილი.',
	},
