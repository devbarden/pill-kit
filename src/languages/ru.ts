...
export const ru: TypeLanguage = {
	reminders: {
		takeMedicine: `Время принять лекарство`,
	},
	...
	welcome: {
		...
		modal: {
			...
			notification: {
				title: 'Уведомления',
				description: `Чтобы получать напоминания, пожалуйста, разрешите приложению доступ отправки уведомлений. В ином случае, мы не сможем напоминать вам, когда принимать лекарства.`,
			},
		},
	},
